      ...
      <form onSubmit={submit} className="space-y-5">
        <div>
          ...
          <input
            ...
            autoFocus
            className="w-full h-11 px-4 rounded-md border border-neutral-200 bg-white outline-none focus:border-neutral-400 text-sm"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-4 py-3 rounded-md border border-neutral-200 bg-white outline-none focus:border-neutral-400 text-sm resize-none"
          />
        </div>
        ...
        <div className="flex items-center gap-3 pt-2">
          <button
            type="submit"
            disabled={pending}
            className="h-11 px-6 rounded-md bg-black text-white text-sm font-medium hover:bg-neutral-800 transition-colors disabled:opacity-50 inline-flex items-center gap-2"
          >
          ...
          <button
            ...
            onClick={skip}
            disabled={pending}
            className="text-xs text-neutral-500 hover:text-black underline underline-offset-4 disabled:opacity-50"
          >
            Skip for now
          </button>
        </div>
